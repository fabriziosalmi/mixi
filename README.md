...
<p align="center">
  ...
  Dual decks, Rust/Wasm DSP, WebGPU visuals, 20 instruments, automixer, beatmatching, 17 skins, MIDI, headphone cue.
</p>
...
| Module | What It Does |
|--------|-------------|
| **Dual Decks** | Independent transport, pitch/tempo, hot cues, loops, scratch emulation. 20 pluggable deck modes: Track, Groovebox, TurboKick, TurboBass + 17 community instruments (TurboAcid, TurboFM, TurboSynth, TurboVox, and more via [mixi-decks](https://github.com/fabriziosalmi/mixi-decks)). |
...
src/
  ...
  decks/          Pluggable deck modes (TurboKick, TurboBass + 17 community decks)
