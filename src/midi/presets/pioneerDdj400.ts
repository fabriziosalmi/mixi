/* Pioneer DDJ-400 — VERIFIED from Mixxx Pioneer-DDJ-400.midi.xml
   Ch1=DeckA, Ch2=DeckB, Ch7=Master. Pioneer DDJ family CC schema. */
import { buildDeckPreset } from './helpers';
export const PIONEER_DDJ_400_PRESET = buildDeckPreset({
