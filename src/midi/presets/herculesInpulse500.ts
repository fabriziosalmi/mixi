/* Hercules DJControl Inpulse 500 — VERIFIED from Mixxx script
   Ch1=DeckA, Ch2=DeckB, Ch3=Master. Hercules Inpulse family. */
import { buildDeckPreset } from './helpers';
export const HERCULES_INPULSE_500_PRESET = buildDeckPreset({
