...
@keyframes rainbowSweep {
  0%   { background-position: -120% center; -webkit-text-fill-color: transparent; }
  100% { background-position: 220% center; -webkit-text-fill-color: transparent; }
}
...
.VPHero .main .text.rainbow-sweep {
  ...
  animation: rainbowSweep 0.9s cubic-bezier(0.4, 0, 0.2, 1) forwards;
}
.VPHero .main .tagline {
  font-size: 1.05rem;
  line-height: 1.7;
